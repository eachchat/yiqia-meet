...
/**
 * The react-native side of Yiqia Meet's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Yiqia Meet to
     *        a conference call.
     * @param handle - a call handle which by default is Yiqia Meet room's URL.
