...
export default [
     ...
     * provided by, for example, Yiqia Meet SDK for iOS.
     *
     * @type string
     */
    'callDisplayName',
     ...
     * override/overwrite provided by, for example, Yiqia Meet SDK for iOS.
     *
     * @type string
     */
    'callHandle',
     ...
     * which Yiqia Meet is to work with a CallKit call created outside of Jitsi
     * Meet and to be adopted by Yiqia Meet such as, for example, an incoming
     * and/or outgoing CallKit call created by Yiqia Meet SDK for iOS
     * clients/consumers prior to giving control to Yiqia Meet. As the value is
     * associated with a conference/meeting, the value makes sense not as a
     * deployment-wide configuration, only as a runtime configuration
     * override/overwrite provided by, for example, Yiqia Meet SDK for iOS.
     *
