...
/**
 * Signals that the configuration (commonly known in Yiqia Meet as config.js)
...
/**
 * Signals that a configuration (commonly known in Yiqia Meet as config.js)
...
/**
 * Stores a specific Yiqia Meet config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Yiqia Meet config.js to store.
 * @returns {Function}
 */
