...
var config = {
    ...
    // Moves all Yiqia Meet 'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    */
     ...
     * which is retrieved internally by Yiqia Meet) (e.g. https://meet.jit.si/someMeeting
