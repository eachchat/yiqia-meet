...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Yiqia Meet in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Yiqia Meet.
     *
    ...
    /**
     * Getter for the prejoin video element in Yiqia Meet.
     *
    ...
    /**
     * Getter for participant specific video element in Yiqia Meet.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Yiqia Meet
    ...
    /**
     * Removes the listeners and removes the Yiqia Meet frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Yiqia Meet.
     *
     ...
     * Only applies to certain Yiqia Meet deploys.
